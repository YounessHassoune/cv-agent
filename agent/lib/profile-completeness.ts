import { type ProfileCompleteness, scoreProfile } from "../../lib/profile-completeness.ts";
import { db } from "./db.ts";

export type { ProfileCompleteness } from "../../lib/profile-completeness.ts";
export { COMPLETE_THRESHOLD } from "../../lib/profile-completeness.ts";
